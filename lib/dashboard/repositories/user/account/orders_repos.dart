...
class OrdersRepository {
  Future<List<OrderModel>> fetchOrders() async {
    ...
    var url = Uri.parse('https://narrid.com/mobile/users/account/orders.php');
  ...
  Future<String> fetchImage(id) async {
    var url =
        Uri.parse('https://narrid.com/mobile/users/account/orders-image.php');
    var response = await http.post(url, body: {
      'id': '$id',
    });
  ...
  Future<List<OrderProductModel>> fetchOrderProduct(id) async {
    var url = Uri.parse('https://narrid.com/mobile/users/account/order.php');
    var response = await http.post(url, body: {
      'id': '$id',
    });
  ...
  Future<String> fetchProductImage(id) async {
    var url =
        Uri.parse('https://narrid.com/mobile/users/account/product-image.php');
    var response = await http.post(url, body: {
      'id': '$id',
    });
