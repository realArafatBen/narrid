...
class GrocerySearchRepository {
  Future<List<SearchModal>> fetchSearch(String q) async {
    var url = Uri.parse('https://narrid.com/mobile/grocery/search.php');
  ...
  Future<List<ProductsModel>> getCatalog(name) async {
    var url = Uri.parse('https://narrid.com/mobile/grocery/catalog.php');
    var response = await http.post(url, body: {
      'q': '$name',
    });
