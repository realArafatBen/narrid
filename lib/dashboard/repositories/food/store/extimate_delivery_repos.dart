...
class ExtimateDeliveryRepos {
  Future<Map<String, dynamic>> getExtimateTime(origin_lat, origin_lng) async {
    ...
    var link =
        "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=$origin_lat,$origin_lng&destinations=$lat%2C$lng&key=AIzaSyBIgZP9pMhvjCCen9THQLMGG3vOxKoEldA";
