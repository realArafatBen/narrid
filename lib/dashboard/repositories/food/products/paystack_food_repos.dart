...
class PaystackFoodRespo {
  Future<Map<String, dynamic>> initialize(
    ...
    FoodProductRep cartRepository = FoodProductRep();
    ...
    var url = Uri.parse('https://narrid.com/mobile/food/initialize.php');
  ...
  Future<Map<String, dynamic>> verify(String ref) async {
    var url = Uri.parse('https://narrid.com/mobile/food/verify.php');
