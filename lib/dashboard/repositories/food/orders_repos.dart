...
class FoodOrdersRepository {
  Future<List<OrderModel>> fetchOrders() async {
    ...
    var url = Uri.parse('https://narrid.com/mobile/food/order/orders.php');
  ...
  Future<String> fetchImage(id) async {
    var url =
        Uri.parse('https://narrid.com/mobile/food/order/orders-image.php');
    var response = await http.post(url, body: {
      'id': '$id',
    });
  ...
  Future<List<OrderProductModel>> fetchOrderProduct(id) async {
    var url = Uri.parse('https://narrid.com/mobile/food/order/order.php');
    var response = await http.post(url, body: {
      'id': '$id',
    });
  ...
  Future<String> fetchProductImage(id) async {
    var url =
        Uri.parse('https://narrid.com/mobile/food/order/product-image.php');
    var response = await http.post(url, body: {
      'id': '$id',
    });
