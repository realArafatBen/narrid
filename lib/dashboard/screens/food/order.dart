...
import 'package:narrid/dashboard/bloc/food/order/order_bloc.dart';
import 'package:narrid/dashboard/bloc/food/order/product_image_bloc.dart';
...
class FoodOrder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
            FoodOrderBloc(ordersRepository: FoodOrdersRepository())
              ..add(Started(id: id)),
  ...
  Widget _buildSaleProducts() {
    return Container(
      ...
      width: double.infinity,
      padding: EdgeInsets.all(9),
      child: BlocBuilder<FoodOrderBloc, OrdersState>(
              ...
              children: [
                for (var product in products)
                  Container(
                    ...
                    child: Row(children: [
                      BlocProvider(
                        create: (context) => FoodProductImageBloc(
                            ordersRepository: FoodOrdersRepository())
                          ..add(ImageStarted(id: product.id)),
                        child: BlocBuilder<FoodProductImageBloc, OrderState>(
