...
import 'package:narrid/dashboard/bloc/food/order/order_image_bloc.dart';
import 'package:narrid/dashboard/bloc/food/order/orders_bloc.dart';
...
import 'package:narrid/dashboard/screens/food/order.dart';
...
class Orders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
            FoodOrdersBloc(ordersRepository: FoodOrdersRepository())
              ..add(Started()),
  ...
  Widget buildOrderList() {
    return BlocBuilder<FoodOrdersBloc, OrdersState>(builder: (context, state) {
      if (state is Loading) {
        return Container(
          child: Center(
                ...
                Card(
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        BlocProvider(
                          create: (context) => FoodOrderImageBloc(
                              ordersRepository: FoodOrdersRepository())
                            ..add(ImageStarted(id: list[i].id)),
                          child: BlocBuilder<FoodOrderImageBloc, OrderState>(
