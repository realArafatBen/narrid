...
import 'package:narrid/dashboard/bloc/grocery/products/cart_page_bloc.dart';
...
import 'package:narrid/dashboard/screens/grocery/checkout.dart';
import 'package:narrid/dashboard/screens/user/auth/login.dart';

class CartGrocery extends StatelessWidget {
  @override
      ...
      providers: [
        BlocProvider<CartGroceryBloc>(
          create: (BuildContext context) =>
              CartGroceryBloc(groceryProductRep: GroceryProductRep())
                ..add(CartPageStarted()),
        ),
  ...
  Widget _loadPageCart(state, context) {
    List<GroceryCartHelper> carts = state.getCartList;
  ...
  Widget separateMethod(context, List<GroceryCartHelper> carts, int i) {
    return BlocProvider(
      create: (context) =>
  ...
  Container productDetails(List<GroceryCartHelper> carts, int i) {
    return Container(
      width: 200,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
