...
import 'package:narrid/dashboard/bloc/grocery/products/verify_payment_grocery_bloc.dart';
...
class GroceryOrderSuccess extends StatelessWidget {
  final ref;
  GroceryOrderSuccess({Key key, @required this.ref}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          VerifyPaymentGroceryBloc(verifyPaymentRespo: PaystackGroceryRespo())
            ..add(VerifyStarted(ref)),
      child: MaterialApp(
        home: Scaffold(
          body: SafeArea(
            child: BlocBuilder<VerifyPaymentGroceryBloc, VerifyPaymentState>(
