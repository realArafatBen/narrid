...
import 'package:narrid/dashboard/bloc/grocery/products/checkout_grocery_bloc.dart';
...
import 'package:narrid/dashboard/screens/grocery/paystack_grocery.dart';
...
class Checkout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MultiBlocProvider(
        providers: [
          BlocProvider<CheckoutGroceryBloc>(
            create: (create) =>
                CheckoutGroceryBloc(groceryProductRep: GroceryProductRep())
  ...
  Widget _buildTotalAmount() {
    return BlocBuilder<CheckoutGroceryBloc, CheckoutProductState>(
  ...
  Widget _buildCartProduct(state) {
    List<GroceryCartHelper> cart = state.getCart;
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => PaystackGrocery(
