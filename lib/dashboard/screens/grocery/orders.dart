...
import 'package:narrid/dashboard/bloc/grocery/order/order_image_bloc.dart';
import 'package:narrid/dashboard/bloc/grocery/order/orders_bloc.dart';
...
import 'package:narrid/dashboard/screens/grocery/order.dart';
...
class Orders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
            GroceryOrdersBloc(ordersRepository: GroceryOrdersRepository())
              ..add(Started()),
  ...
  Widget buildOrderList() {
    return BlocBuilder<GroceryOrdersBloc, OrdersState>(
                ...
                Card(
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        BlocProvider(
                          create: (context) => GroceryOrderImageBloc(
                              ordersRepository: GroceryOrdersRepository())
                            ..add(ImageStarted(id: list[i].id)),
                          child: BlocBuilder<GroceryOrderImageBloc, OrderState>(
