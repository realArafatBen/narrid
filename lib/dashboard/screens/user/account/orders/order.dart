...
import 'package:narrid/dashboard/bloc/user/account/order/order_bloc.dart';
import 'package:narrid/dashboard/bloc/user/account/order/product_image_bloc.dart';
...
class UserOrder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => OrderBloc(ordersRepository: OrdersRepository())
          ..add(Started(id: id)),
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      BlocProvider(
                        ...
                        child: BlocBuilder<ProductImageBloc, OrderState>(
