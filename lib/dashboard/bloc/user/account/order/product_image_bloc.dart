...
class ProductImageBloc extends Bloc<OrderEvent, OrderState> {
  final OrdersRepository ordersRepository;

  ProductImageBloc({@required this.ordersRepository}) : super(ImageLoading());
  ...
  Stream<OrderState> mapEventToState(
    ...
    if (event is ImageStarted) {
      try {
        String image = await ordersRepository.fetchProductImage(event.id);
        // print(image);
