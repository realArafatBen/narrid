...
class FoodProductsBloc extends Bloc<ProductsEvent, ProductsState> {
  FoodProductRep foodProductRep;

  FoodProductsBloc(this.foodProductRep) : super(ProductLoading());
    ...
    if (event is ProductStarted) {
      try {
        List<ProductsModel> products =
            await foodProductRep.fetchProducts(event.id, event.storeId);
