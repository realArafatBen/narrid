...
import 'package:narrid/dashboard/bloc/store/products/men_bloc.dart';
...
class BuildFashionMen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => MenBloc(MenRepos())..add(AppStarted()),
      child: Container(
        child: buildListView(),
      ),
    );
  ...
  BlocBuilder buildListView() {
    return BlocBuilder<MenBloc, MenState>(
