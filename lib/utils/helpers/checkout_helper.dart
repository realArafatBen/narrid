...
class CheckoutHelper {
  ...
  static final instance = DatabaseHelper.instance;
  ...
  //fetch row by id
  Future<List<CartHelper>> fetchCartId(id) async {
    Database db = await instance.database;
    ...
    return List.generate(
        ...
        (index) => CartHelper(
              ...
              variant: cart[index]['variant'],
              variantName: cart[index]['variantName'],
  ...
  //fetch row by id
  Future<List<CartHelper>> fetchAllCart() async {
    Database db = await instance.database;
    List<Map<String, dynamic>> cart = await db.query(table);
